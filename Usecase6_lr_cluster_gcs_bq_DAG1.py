...
REGION = "us-central1"
ZONE = "us-central1-a"
PYSPARK_CODE1_URI = "gs://we43-learn1-hari/code/code_Usecase6_step1_gcs_bq.py"  # this code is kept in your bucket location
...
with models.DAG(
    ...
    pyspark_task = DataprocSubmitJobOperator(task_id="pyspark_task1", job=pyspark_job_params, region=REGION,
